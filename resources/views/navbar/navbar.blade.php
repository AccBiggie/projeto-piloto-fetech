    <nav class="navbar navbar-expand-lg navbar-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#sobre" target="">Sobre</a>
                </li>
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/indexHTML/loginfe.html" target="_blank">Atendimento</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="/indexHTML/LojaFetech.html" target="_blank">Loja</a>
                </li> --}}
            </ul>
        </div>
    </nav>
